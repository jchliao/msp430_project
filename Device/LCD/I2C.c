 ...
 * 范       例：无
 ******************************************************************************************************/
__interrupt_vec(USCIAB0TX_VECTOR) void USCIAB0TX_ISR(void)
{
...
#define MCLK_FREQ			12000000						// 此处填写实际时钟频率
...
{
	//__delay_cycles(MCLK_FREQ/1000);			//1000us延时
	//__delay_cycles(MCLK_FREQ/10000);			//100us延时
	//__delay_cycles(MCLK_FREQ/100000);			//10us延时
	//__delay_cycles(MCLK_FREQ/1000000);		//1us延时
}
/******************************************************************************************************
 * 名       称：Start()
 * 功       能：模拟I2C的起始位
